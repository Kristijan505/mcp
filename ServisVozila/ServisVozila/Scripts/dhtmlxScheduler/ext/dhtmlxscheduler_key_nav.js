...
n=e.getActionData(i).date,r=e.getActionData(i).section}),e._make_pasted_event=function(t){var i=t.end_date-t.start_date,s=e._lame_copy({},t);if(a(s),s.start_date=new Date(n),s.end_date=new Date(s.start_date.valueOf()+i),r){var d=e._get_section_property();s[d]=e.config.multisection?t[d]:r}return s},e._do_paste=function(t,i,a){e.addEvent(i),e.callEvent("onEventPasted",[t,i,a])},e._is_key_nav_active=function(){return this._is_initialized()&&!this._is_lightbox_open()&&this.config.key_nav?!0:!1},dhtmlxEvent(document,_isOpera?"keypress":"keydown",function(t){
if(!e._is_key_nav_active())return!0;if(t=t||event,37==t.keyCode||39==t.keyCode){t.cancelBubble=!0;var a=e.date.add(e._date,37==t.keyCode?-1:1,e._mode);return e.setCurrentView(a),!0}var n=e._select_id;if(t.ctrlKey&&67==t.keyCode)return n&&(e._buffer_id=n,s=!0,e.callEvent("onEventCopied",[e.getEvent(n)])),!0;if(t.ctrlKey&&88==t.keyCode&&n){s=!1,e._buffer_id=n;var r=e.getEvent(n);e.updateEvent(r.id),e.callEvent("onEventCut",[r])}if(t.ctrlKey&&86==t.keyCode&&i(t)){var r=e.getEvent(e._buffer_id);if(r){
